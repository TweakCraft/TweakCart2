...
public class TweakCartInventoryTest
{
	...
	private void test()
	{
		ItemStack[] inv =
		{
			new ItemStack(2, 64), new ItemStack(1, 64), new ItemStack(1, 64)
		};
		ItemStack[] inv2 =
		{
			new ItemStack(1, 32), new ItemStack(1, 32), new ItemStack(1, 32), new ItemStack(1, 32), new ItemStack(1, 32), new ItemStack(1, 32)
		};
